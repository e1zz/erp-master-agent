---
name: "tiendanube-api"
description: "Use when you need TiendaNube (Nuvemshop) specific API endpoint details, payloads, authentication, or local ERP implementation references. Provides modular reference files for auth, products/inventory, orders/fulfillment, and webhooks."
version: "1.0.0"
